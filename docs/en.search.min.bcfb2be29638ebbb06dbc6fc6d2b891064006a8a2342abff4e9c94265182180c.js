...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/devops-journal/flexsearch.min.js');loadScript('/devops-journal/en.search-data.min.41881f4df56c5524b1cdbab2beebb7fe28c99892bdcca1fa5dd97b966eb89fcc.js',function(){input.required=false;search();});}
