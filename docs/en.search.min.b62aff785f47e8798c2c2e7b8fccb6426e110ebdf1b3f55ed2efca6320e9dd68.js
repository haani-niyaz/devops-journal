...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/devops-journal/flexsearch.min.js');loadScript('/devops-journal/en.search-data.min.c24c299db4003573a006349e8c7b704b5c9a44e309db5046138f7ba5014ee0ac.js',function(){input.required=false;search();});}
